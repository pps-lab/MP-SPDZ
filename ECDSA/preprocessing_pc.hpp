...
#ifndef ECDSA_PREPROCESSING_PC_HPP_
#define ECDSA_PREPROCESSING_PC_HPP_
...
void preprocessing(vector<EcTuple<SpdzWiseRepFieldShare>>& tuples, int buffer_size,
        ...
        EcdsaOptions opts)
{
    ...
    auto& MCp = proc.MC;
    typedef SpdzWiseRepFieldShare<typename P256Element::Scalar> pShare;
    typedef SpdzWiseRepFieldShare<P256Element> cShare;
...
template<>
void check<SpdzWiseRepFieldShare>(vector<EcTuple<SpdzWiseRepFieldShare>>& tuples, SpdzWiseRepFieldShare<P256Element::Scalar> sk,
    P256Element::Scalar alphai, Player& P)
{
    typename SpdzWiseRepFieldShare<P256Element::Scalar>::MAC_Check MC(alphai);
...
#endif /* ECDSA_PREPROCESSING_PC_HPP_ */
