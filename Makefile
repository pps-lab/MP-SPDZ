...
poly_commit: libff $(patsubst ECDSA/%.cpp,%.x,$(wildcard ECDSA/*-pc-party.cpp)) $(patsubst ECDSA/%.cpp,%.x,$(wildcard ECDSA/*-pe-party.cpp)) $(patsubst ECDSA/%.cpp,%.x,$(wildcard ECDSA/*-switch-party.cpp)) Fake-ECDSA.x $(BLS)
...
%-pc-party.x: ECDSA/%-pc-party.o ECDSA/P256Element.o ECDSA/P377Element.o $(VM) $(BLS)
	$(CXX) -o $@ $(CFLAGS) $^ $(LDLIBS)
%-pe-party.x: ECDSA/%-pe-party.o ECDSA/P256Element.o ECDSA/P377Element.o $(VM) $(BLS)
	$(CXX) -o $@ $(CFLAGS) $^ $(LDLIBS)
