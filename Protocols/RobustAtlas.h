...
#ifndef PROTOCOLS_ROBUSTATLAS_H_
#define PROTOCOLS_ROBUSTATLAS_H_
...
/**
 * ATLAS protocol (with authentication tags to achieve robustness).
 * Uses double sharings to reduce degree of Shamir secret sharing.
 */

template<class T>
class RobustAtlas : public Atlas<T>
{
...
#endif /* PROTOCOLS_ROBUSTATLAS_H_ */
