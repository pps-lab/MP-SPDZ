...
#$BIN -p 0 -N 3 --n_bits 34 --n_shares 2977 --out_start 2396508 & ; pid0=$!
#$BIN -p 1 -N 3 --n_bits 34 --n_shares 2977 --out_start 2396508 & ; pid1=$!
#$BIN -p 2 -N 3 --n_bits 34 --n_shares 2977 --out_start 2396508 & ; pid2=$!
#wait $pid0 $pid1 $pid2
##
echo "====================";
