/*
 * DealerMaliciousPrep.h
 *
 */

#ifndef GC_DEALERMALICIOUSPREP_H_
#define GC_DEALERMALICIOUSPREP_H_

#include "Protocols/DealerMaliciousPrep.h"
...
namespace GC
{
class DealerMaliciousPrep : public BufferPrep<DealerSecret>, ShiftableTripleBuffer<DealerSecret>
{
    Player* P;

public:
    DealerMaliciousPrep(DataPositions& usage, int = -1) :
...
#endif /* GC_DEALERMALICIOUSPREP_H_ */
